...
<div class="row-fluid">
	<div class="span12">
		...
		<ul class="breadcrumb">
			...
			<li><a href="/admin/district">Quận / Huyện</a></li>
		</ul>
	...
	<div class="span12">
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">Quận / Huyện </div>
				<div class="tools">
			...
			<div class="portlet-body form" style="display: block;">
				<div class="buttons">
					...
					<?php } ?>
					<a href="admin/district/lists" class="btn btn-primary"><i class="icon-list"></i> <?php echo lang('list');?></a>
					<a href="admin/district/create" class="btn btn-success"><i class="icon-plus"></i> <?php echo lang('create');?></a></div>
				<br class="clear"/>

				<?php if (isset($form)) echo $form; ?>
				<?php if (isset($districts)) { ?>

				<form action="/admin/district/delete" method="post" id="form">
					...
					<table class="table table-striped table-bordered table-hover" id="dataTable">
						...
						<tbody>
							...
							<tr class="odd gradeX">
								...
								<td><i><?php $city = new Model_City($c->city_id); echo $city->name."</i> › <b>".$c->name;?></b></td>
								<td class="hidden-480"><?php echo $c->sort;?></td>
								<td class="hidden-480"><?php echo ($c->enable)?' On':' Off';?></td>
								<td><a href="/admin/district/edit/<?php echo $c->id;?>"><i class="icon-pencil"></i> <?php echo lang('edit') ?></a></td>
							</tr>
							<?php } ?>
						</tbody>
					</table>
