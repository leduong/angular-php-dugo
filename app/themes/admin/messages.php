		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form" style="display: block;">
				<div class="buttons">
					...
					<?php } ?>
					<a href="admin/messages/lists" class="btn btn-primary"><i class="icon-list"></i> <?php echo lang('list');?></a>
					<a href="admin/messages/create" class="btn btn-success"><i class="icon-plus"></i> <?php echo lang('create');?></a></div>
				<br class="clear"/>

				<?php if (isset($form)) echo $form; ?>
				<?php if (isset($messages)) { ?>

				<form action="/admin/messages/delete" method="post" id="form">
					...
					<table class="table table-striped table-bordered table-hover" id="dataTable">
						...
						<tbody>
							...
							<tr class="odd gradeX">
								...
								<td><a href="/admin/messages/edit/<?php echo $c->id;?>"><i class="icon-pencil"></i> <?php echo lang('edit') ?></a></td>
							</tr>
							<?php } ?>
						</tbody>
					</table>
