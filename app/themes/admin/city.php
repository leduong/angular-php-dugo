...
<div class="row-fluid">
	<div class="span12">
		...
		<ul class="breadcrumb">
			...
			<li><a href="/admin/city">Tỉnh/Thành</a></li>
		</ul>
	...
	<div class="span12">
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">Tỉnh/Thành</div>
				<div class="tools">
			...
			<div class="portlet-body form" style="display: block;">
				<div class="buttons">
					...
					<?php } ?>
					<a href="admin/city/lists" class="btn btn-primary"><i class="icon-list"></i> <?php echo lang('list');?></a>
					<a href="admin/city/create" class="btn btn-success"><i class="icon-plus"></i> <?php echo lang('create');?></a></div>
				<br class="clear"/>

				<?php if (isset($form)) echo $form; ?>
				<?php if (isset($cities)) { ?>

				<form action="/admin/city/delete" method="post" id="form">
					...
					<table class="table table-striped table-bordered table-hover" id="dataTable">
						...
						<tbody>
							...
							<tr class="odd gradeX">
								...
								<td><a href="/admin/city/edit/<?php echo $c->id;?>"><i class="icon-pencil"></i> <?php echo lang('edit') ?></a></td>
							</tr>
							<?php } ?>
						</tbody>
					</table>
