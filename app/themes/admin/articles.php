...
<div class="buttons">
	...
	<?php } ?> 
	<a href="admin/articles/lists" class="button green right mr mb"><small class="icon documents"></small><span><?php echo lang('list');?></span></a>
	<a href="admin/articles/create" class="button green right mr mb"><small class="icon plus"></small><span><span><?php echo lang('create');?></span></span></a> </div>
<br class="clear"/>
...
<form action="/admin/articles/delete" method="post" id="form">
	<table class="list">
		<tr>
			<th style="width:10px">
		...
		<tr>
			...
			<td><?php if($c->category_id){$parent = new Model_Articles($c->category_id);echo $parent->name;}?></td>
			<td><?php echo $c->sort_order;?></td>
			<td class="center"><a class="checkbox<?php echo ($c->status)?' on':' off';?>"><small></small></a></td>
			<td class="center"><a href="/admin/articles/edit/<?php echo $c->id;?>" class="button yellow"><small class="icon pencil"></small><span><?php echo lang('edit');?></span></a></td>
		</tr>
		<?php }?>
	</table>
</form>
