		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form" style="display: block;">
				<div class="buttons">
					...
					<?php } ?>
					<a href="admin/likes/lists" class="btn btn-primary"><i class="icon-list"></i> <?php echo lang('list');?></a>
					<a href="admin/likes/create" class="btn btn-success"><i class="icon-plus"></i> <?php echo lang('create');?></a></div>
				<br class="clear"/>

				<?php if (isset($form)) echo $form; ?>
				<?php if (isset($likes)) { ?>

				<form action="/admin/likes/delete" method="post" id="form">
					...
					<table class="table table-striped table-bordered table-hover" id="dataTable">
						...
						<tbody>
							...
							<tr class="odd gradeX">
								...
								<td><?php $user = new Model_User($c->by); echo $user->username; ?></td>
								<td><?php echo $c->time;?></td>
								<td><a href="/admin/likes/edit/<?php echo $c->id;?>"><i class="icon-pencil"></i> <?php echo lang('edit') ?></a></td>
							</tr>
							<?php } ?>
						</tbody>
					</table>
