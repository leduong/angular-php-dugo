		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form" style="display: block;">
				<div class="buttons">
					...
					<?php } ?>
					<a href="admin/comments/lists" class="btn btn-primary"><i class="icon-list"></i> <?php echo lang('list');?></a>
					<a href="admin/comments/create" class="btn btn-success"><i class="icon-plus"></i> <?php echo lang('create');?></a></div>
				<br class="clear"/>

				<?php if (isset($form)) echo $form; ?>
				<?php if (isset($comments)) { ?>

				<form action="/admin/comments/delete" method="post" id="form">
					...
					<table class="table table-striped table-bordered table-hover" id="dataTable">
						...
						<tbody>
							...
							<tr class="odd gradeX">
								...
								<td><?php $u = new Model_User($c->uid); echo $u->username;?></td>
								<td><?php $m = new Model_Messages($c->mid); echo $m->message;?></td>
								<td><?php echo $c->message; ?></td>
								<td><?php echo date('d/m/Y H:i:s', strtotime($c->time));?></td>
								<td><a href="/admin/comments/edit/<?php echo $c->id;?>"><i class="icon-pencil"></i> <?php echo lang('edit') ?></a></td>
							</tr>
							<?php } ?>
						</tbody>
					</table>
